...
func fetchReleaseUsingRequestArgs(db database.DB, w http.ResponseWriter, r *http.Request, p models.Project) (models.Release, error) {
	vars := mux.Vars(r)
	...
	release, err := mFindRelease(db, p, releaseId)
	if err != nil {
...
func getRelease(db database.DB) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		release, err := fetchReleaseUsingRequestArgs(db, w, r, project)
		if err != nil {
